...
const Hero = () => {
	...
	return (
		<StaticQuery
			...
			render={(data) => {
				return (
					<HeroBackground Tag="section" fluid={data.hero.childImageSharp.fluid} backgroundColor={`#040e18`}>
						<HeroContentContainer>
							<HeroHeader color={Flour}>Cannabis infusion tester </HeroHeader>
							<BR1 />
							<HeroLead color={Flour}>
								Thousands of cannabis professionals are testing their infusions, cannabis flower, and
								concentrate with tCheck.
							</HeroLead>
							<BR2 />
